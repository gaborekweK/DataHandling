...
# All cells regression equations from all trials (Row 2 data from fit_all.py output)
all_cells_equations = {
    'Cell 1': {
        'Trial 1': {'slope': 85.324, 'intercept': -5596.515, 'r_squared': 0.991},
        'Trial 2': {'slope': 93.610, 'intercept': -6132.320, 'r_squared': 0.991}, 
        'Trial 3': {'slope': 96.600, 'intercept': -6334.996, 'r_squared': 0.994},
        'Trial 4': {'slope': 89.752, 'intercept': -5889.259, 'r_squared': 0.993}
    },
    'Cell 2': {
        'Trial 1': {'slope': 91.933, 'intercept': -6009.361, 'r_squared': 0.993},
        'Trial 2': {'slope': 88.700, 'intercept': -5800.637, 'r_squared': 0.997}, 
        'Trial 3': {'slope': 89.700, 'intercept': -5874.492, 'r_squared': 0.993},
        'Trial 4': {'slope': 95.800, 'intercept': -6273.888, 'r_squared': 0.992}
    },
    'Cell 3': {
        'Trial 1': {'slope': 89.167, 'intercept': -5823.179, 'r_squared': 0.995},
        'Trial 2': {'slope': 91.700, 'intercept': -6000.428, 'r_squared': 0.990}, 
        'Trial 3': {'slope': 102.433, 'intercept': -6709.767, 'r_squared': 0.987},
        'Trial 4': {'slope': 90.033, 'intercept': -5880.269, 'r_squared': 0.995}
    },
    'Cell 4': {
        'Trial 1': {'slope': 94.705, 'intercept': -6168.307, 'r_squared': 0.987},
        'Trial 2': {'slope': 93.067, 'intercept': -6059.195, 'r_squared': 0.993}, 
        'Trial 3': {'slope': 105.200, 'intercept': -6859.374, 'r_squared': 0.980},
        'Trial 4': {'slope': 88.700, 'intercept': -5773.937, 'r_squared': 0.993}
    },
    'Cell 5': {
        'Trial 1': {'slope': 98.433, 'intercept': -6420.617, 'r_squared': 0.994},
        'Trial 2': {'slope': 91.967, 'intercept': -5993.476, 'r_squared': 0.994}, 
        'Trial 3': {'slope': 97.467, 'intercept': -6359.926, 'r_squared': 0.996},
        'Trial 4': {'slope': 40.996, 'intercept': -2649.130, 'r_squared': 0.971}
    },
    'Cell 6': {
        'Trial 1': {'slope': 94.300, 'intercept': -6159.756, 'r_squared': 0.993},
        'Trial 2': {'slope': 92.633, 'intercept': -6050.101, 'r_squared': 0.994}, 
        'Trial 3': {'slope': 104.100, 'intercept': -6807.949, 'r_squared': 0.988},
        'Trial 4': {'slope': 90.933, 'intercept': -5950.201, 'r_squared': 0.993}
    }
}
